...
const galleryImages = [
  { url: 'https://res.cloudinary.com/dbc9mudek/image/upload/v1778535278/IMG_6778_-_Jake_Barrow_ilzr5v.jpg', label: 'Chapter Service', row: 'span 2' },
  ...
  { url: 'https://res.cloudinary.com/dbc9mudek/image/upload/v1778534838/IMG_1242_iahazo.jpg', label: 'Service Hours', row: 'span 2' },
  { url: 'https://res.cloudinary.com/dbc9mudek/image/upload/v1778535278/IMG_0107_-_Simone_Wilt_jbnlr2.jpg', label: 'NHS Member' },
  { url: 'https://res.cloudinary.com/dbc9mudek/image/upload/v1778534835/IMG_1239_ljcdnt.jpg', label: 'Chapter Event', row: 'span 2' },
      ...
      {open !== null && (
        <div onClick={() => setOpen(null)}
          ...
          <div onClick={(e) => e.stopPropagation()}
            style={{ background: 'var(--paper)', maxWidth: 700, width: '100%', padding: 24 }}>
            <img src={galleryImages[open].url} alt={galleryImages[open].label}
              style={{ width: '100%', maxHeight: 560, objectFit: 'contain', display: 'block', marginBottom: 20 }} />
